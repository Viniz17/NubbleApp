...
export function Text({
    children, preset = 'paragraphMedium', bold, italic, medium, style, ...sRTextProps
}: TextProps) {
...
function getFontFamily(preset: TextVariants, bold?: boolean, italic?: boolean, medium?: boolean): string {
    if (
        preset === 'headingLarge' ||
...
export const $fontSizes: Record<TextVariants, TextStyle> = {
    ...
    paragraphSmall: { fontSize: 14, lineHeight: 19 },

    paragraphCaption: { fontSize: 12, lineHeight: 16 },
